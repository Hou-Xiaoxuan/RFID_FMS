...
public class KillTags implements TagOpCompleteListener {
    ...
    void run() {
        ...
        try {
            ...
            if (targetEpc == null) {
                throw new Exception("You must specify the '" + SampleProperties.targetTag + "' property "
                        + "for this example as the block permalock command " + "is not reversible");
            }
            ...
            System.out.println("Trying to kill tag matching EPC pattern " + targetEpc);
